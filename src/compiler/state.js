...
/** @type {NonNullable<import('./types.js').CompilerOptions['warningFilter']>} */
 ...
 * @type {Map<import('#ast').ZvelteNode | NodeLike, Set<string>[]>}
 */
...
/**
 * @param {import('#ast').ZvelteNode | NodeLike} node
