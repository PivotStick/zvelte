...
export default defineTest({
    html: [
        ...
        `<div itemscope="" itemtype="https://schema.org/SoftwareApplication"><span itemprop="name">Game</span> - REQUIRES`,
        ...
        `id="offers"`,
        `itemscope=""`,
        `itemtype="https://schema.org/Offer">Price: $<span itemprop="price">1.00</span>`,
