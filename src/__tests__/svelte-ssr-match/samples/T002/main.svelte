...
<footer
    ...
    style="background-image:url('images/demo-decor-store-footer-bg.jpg'); margin-top: auto;"
>
    <div class="container pt-4 pb-4 md-pt-45px md-pb-45px">
        <div class="row justify-content-center">
            <!-- start footer column -->
            <div
                class="col-6 col-lg-3 last-paragraph-no-margin order-sm-1 md-mb-50px xs-mb-30px"
            >
                <a
                    href="demo-decor-store.html"
                    class="footer-logo mb-15px d-inline-block"
                    ><img
                        src="images/demo-decor-store-logo-white.png"
                        data-at2x="images/demo-decor-store-logo-white@2x.png"
                        alt=""
                    /></a
                >
            ...
            <!-- start footer column -->
            <div
                class="col-6 col-lg-2 col-sm-4 xs-mb-30px order-sm-3 order-lg-2"
            >
                <span class="fs-16 alt-font fw-500 d-block text-white mb-5px"
                    >Categories</span
                >
                <ul>
                    <li><a href="demo-decor-store-shop.html">Bed room</a></li>
                    <li>
                        <a href="demo-decor-store-shop.html">Living room</a>
                    </li>
                    <li><a href="demo-decor-store-shop.html">Lightning</a></li>
                    <li>
                        <a href="demo-decor-store-shop.html">Fabrics sofa</a>
                    </li>
                </ul>
            </div>
            <!-- end footer column -->
            ...
            >
                ...
                <ul>
                    ...
                    <li>
                        <a href="demo-decor-store-contact.html">Contact us</a>
                    </li>
            ...
            >
                ...
                <ul>
                    <li>
                        <a href="demo-decor-store-account.html">My account</a>
                    </li>
                    <li><a href="demo-decor-store-cart.html">Orders</a></li>
                    <li>
                        <a href="demo-decor-store-checkout.html">Checkout</a>
                    </li>
            ...
            <!-- start footer column -->
            <div
                class="col-lg-3 col-sm-6 ps-20px sm-ps-15px md-mb-50px xs-mb-0 order-sm-2 order-lg-5"
            >
                <span class="fs-16 alt-font fw-500 d-block text-white mb-5px"
                    >Newsletter</span
                >
                ...
                <div
                    class="d-inline-block w-100 newsletter-style-02 position-relative mb-15px"
                >
                    <form
                    ...
                    >
                        ...
                        <button class="btn pe-20px submit" aria-label="submit"
                            ><i
                                class="icon feather icon-feather-mail icon-small text-white"
                            ></i></button
                        >
                        <div
    ...
    <div
        class="border-top border-color-transparent-white-light pt-30px pb-30px"
    >
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                >
                    ...
                    <p class="fs-14 w-90 xl-w-100">
                        C 2024 Crafto is Proudly Powered by <a
                ...
                >
                    ...
                    <a href="tel:12345678910" class="fs-16 text-white fw-500"
                        >+1 234 567 8910</a
                    >
                </div>
                <div
                ...
                >
                    ...
                    <a
                        ...
                        class="fs-16 text-white fw-500">info@domain.com</a
                    >
                </div>
            </div>
        </div>
